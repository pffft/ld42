...
namespace AI
{
    public class EventQueue
    {
        ...
        public void Add(Moves.Move move) {

            AISequence sequence = move.GetSequence();
            if (sequence == null)
            {
            ...
            if (move.GetName() == null || move.GetDescription() == null)
            {
            ...
            {
                Debug.Log("Added Move \"" + move.GetName() + "\" to queue. Here's what it says it'll do: \"" + move.GetDescription() + "\".");
            }

            Add(move.GetFinalSequence());
        }
         ...
         */
        public void AddRepeat(int times, Moves.Move move)
        {
            for (int i = 0; i < times; i++)
            {
                Add(move);
