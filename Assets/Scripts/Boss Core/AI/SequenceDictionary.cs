...
namespace AI
{
    public partial class AISequence
    {
        ...
        public static AISequence AOE_TEST_3 = new AISequence(
            5f,
            Merge(
                ShootAOE(AOE.New(self).Speed(Speed.SNAIL).InnerScale(0f).InnerSpeed(Speed.FROZEN).On(0, 360f).MaxTime(3.25f)).Wait(3.25f),

                ShootAOE(AOE.New(self).Speed(Speed.SNAIL).InnerScale(0f).InnerSpeed(Speed.FROZEN).AngleOffset(45f)
                         .On(-22.5f, 22.5f)
                         .On(90 - 22.5f, 90 + 22.5f)
                         .On(180 - 22.5f, 180 + 22.5f)
                         .On(270 - 22.5f, 270 + 22.5f))
                .Wait(3.25f).SetSpeed(Speed.FROZEN).InnerSpeed(Speed.FROZEN).Wait(1f).RotationSpeed(-30f),

                ShootAOE(AOE.New(self).Speed(Speed.SLOW).InnerScale(0.5f).InnerSpeed(Speed.SNAIL)
                         .On(-22.5f, 22.5f)
                         .On(90 - 22.5f, 90 + 22.5f)
                         .On(180 - 22.5f, 180 + 22.5f)
                         .On(270 - 22.5f, 270 + 22.5f))
                ...
                //Pause(3.5f).Then(Shoot1(New(self).Size(Size.MEDIUM).Speed(Speed.VERY_FAST)).Wait(0.5f).Times(20))
            ).Wait(10f)
        );
