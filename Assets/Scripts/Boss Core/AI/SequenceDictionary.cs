...
namespace AI
{
    public partial class AISequence
    {
        ...
        //public static AISequence EITHER_TEST = new AISequence(
        //    4,
        //    Shoot1(New(self).Size(Size.MEDIUM)).Wait(0.1f).Times(10).Wait(1f),
        //    Either(
        //        Shoot1(New(self).Size(Size.LARGE).Speed(Speed.SLOW)),
        //        Shoot3()
        //    ).Wait(1f),
        //    Shoot1().Wait(0.1f).Times(10).Wait(2f)
        //);
        ...
        public static AISequence SWEEP_BACK_AND_FORTH = new AISequence(
            ...
            Teleport(),
            new AISequence(() => {
                Debug.Log("Generation function called");
                List<AISequence> sequences = new List<AISequence>();
                for (int i = -30; i < 90; i += 5)
                {
                    sequences.Add(Shoot1(New(self).AngleOffset(i)).Wait(0.01f));
