...
public class ProjectileManager {
    ...
    public void spawnMedium(Vector3 spawn, Vector3 target, float angleOffset = 0, Speed speed = Speed.MEDIUM)
    {
        Quaternion offset = Quaternion.AngleAxis(angleOffset, Vector3.up);
        ...
        Projectile.CreateMedium(this.entity, spawn, offset * Quaternion.FromToRotation(Vector3.forward, topDownTarget - topDownSpawn), (float)speed, 10f);
    }
    ...
    public void spawnCurving(Vector3 spawn, Vector3 target, float curveAmount, float angleOffset = 0, Speed speed = Speed.MEDIUM) {
        Quaternion offset = Quaternion.AngleAxis(angleOffset, Vector3.up);
        ...
        ProjectileCurve.Create(this.entity, spawn, offset * Quaternion.FromToRotation(Vector3.forward, topDownTarget - topDownSpawn), (float)speed, curveAmount, 3f);
    }
